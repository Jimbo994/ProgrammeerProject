...
/**
 * Created by Jim on 27-1-2017.
 */

public class CustomTaskAdapter extends ArrayAdapter<String> {
    public CustomTaskAdapter(Context context, ArrayList values){

        super(context, R.layout.custom_listview_tasks, values);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View theView = theInflater.inflate(R.layout.custom_listview_tasks, parent, false);
